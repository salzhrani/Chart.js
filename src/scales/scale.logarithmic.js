		...
		if (me.isHorizontal()) {
			...
			if (start === 0 && !tickOpts.reverse) {
				...
				if (newVal === start) {
					...
					pixel = me.bottom - innerDimension * 0.02 - (innerDimension * 0.98/ range * (log10(newVal)-log10(me.minNotZero)));
				}
				...
				if (newVal === me.end) {
					...
					pixel = me.top + innerDimension * 0.02 + (innerDimension * 0.98/ range * (log10(newVal)-log10(me.minNotZero)));
				}
			} else {
				range = log10(me.end) - log10(start);
				innerDimension = me.height;
				pixel = me.bottom - (innerDimension / range * (log10(newVal) - log10(start)));
			}
		}
		return pixel;
	}
