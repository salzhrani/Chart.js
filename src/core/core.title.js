...
function createNewTitleBlockAndAttach(chartInstance, titleOpts) {
	...
	layoutService.addBox(chartInstance, title);
}
...
plugins.register({
	...
	beforeUpdate: function(chartInstance) {
		...
		if (titleOpts) {
			titleOpts = configMerge(defaults.global.title, titleOpts);
			...
			layoutService.removeBox(chartInstance, chartInstance.titleBlock);
