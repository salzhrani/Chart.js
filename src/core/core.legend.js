...
export default class Legend extends Element {
	...
	fit() {
		...
		var globalDefault = defaults.global,
			...
			labelFont = fontString(fontSize, fontStyle, fontFamily);
		...
		if (display) {
			...
			if (isHorizontal) {
				...
				each(me.legendItems, function(legendItem, i) {
	...
	handleEvent(e) {
		...
		var position = getRelativePosition(e, me.chart.chart),
			x = position.x,
			y = position.y;
...
function createNewLegendAndAttach(chartInstance, legendOpts) {
	...
	layoutService.addBox(chartInstance, legend);
}
...
plugins.register({
	...
	beforeUpdate: function(chartInstance) {
		...
		if (legendOpts) {
			legendOpts = configMerge(defaults.global.legend, legendOpts);
			...
			layoutService.removeBox(chartInstance, chartInstance.legend);
